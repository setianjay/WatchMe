...
class ContentsFavoriteAdapter(
    private val context: Context,
    private val listener: IOnContentsFavoriteAdapterListener
) : PagedListAdapter<MovieEntity, ContentsFavoriteAdapter.ViewHolder>(DIFF_CALLBACK) {

    interface IOnContentsFavoriteAdapterListener {
